    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="add.do"> 添加内容</a> </li>
                <li>搜索：</li>
                <li>
        ...
        <table class="table table-hover text-center">
            ...
            <volist name="list" id="vo">
                <c:forEach items = "${lists.list}" var="handle">
                    <tr>
                        ...
                        <td width="10%"><img src="${path}/static/images/11.jpg" alt="" width="70" height="50" /></td>
                        <td>${handle.name}</td>
                        <td><fmt:formatDate value="${handle.createTime}" type="both"/></td>
                        <td><fmt:formatDate value="${handle.updateTime}" type="both"/></td>
                        <td><div class="button-group">
                            <a class="button border-main" href="update.do?id=${handle.id}"><span class="icon-edit"></span> 修改</a>
                            <a class="button border-red" href="delete.do?id=${handle.id}"><span class="icon-trash-o"></span> 删除</a> </div></td>
                    </tr>
                </c:forEach>
                <tr>
                        ...
                        <div class="pagelist">
                            ...
                            <c:choose>
                                <c:when test="${lists.hasPreviousPage}">
                                    <a href="list.do?pageNum=${lists.prePage}">上一页</a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <c:forEach items="${lists.navigatepageNums}" var="i">
                                ...
                                <c:if test="${i!=lists.pageNum}">
                                    <a class="current" href="list.do?pageNum=${i}">${i}</a>
                                </c:if>
                            </c:forEach>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="list.do?pageNum=${lists.nextPage}">下一页</a>
                                </c:otherwise>
                            </c:choose>

                        <a href="list.do?pageNum=${lists.pages}">尾页</a>
                        </div>
                    </td>
                </tr>
        </table>
